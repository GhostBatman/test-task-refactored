...
// #refact этот ref лишний, нужно сразу использовать props.item
const innerItem = ref(props.item);

// в текущем исполнении #bug -> надо () => props.item
watch(props.item, () => {
